    ...
    function sysCall_init()
        ...
        if isCustomizationScript then
            ...
            if model.modelVersion==1 then
                ...
                -- Box specific:
                require("/BlueWorkforce/scripts/genericSphere/common")
                require("/BlueWorkforce/scripts/genericSphere/customization_main")
                require("/BlueWorkforce/scripts/genericSphere/customization_dlg")
            end
        else
            -- Child script
