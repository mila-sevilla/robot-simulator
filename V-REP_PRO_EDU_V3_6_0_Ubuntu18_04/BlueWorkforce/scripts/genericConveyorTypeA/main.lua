    ...
    function sysCall_init()
        ...
        if isCustomizationScript then
            ...
            if model.modelVersion==1 then
                ...
                -- Type A specific:
                require("/BlueWorkforce/scripts/genericConveyorTypeA/common")
                require("/BlueWorkforce/scripts/genericConveyorTypeA/customization_main")
                require("/BlueWorkforce/scripts/genericConveyorTypeA/customization_dlg")
            end
        else
            -- Child script
            if model.modelVersion==1 then
                ...
                -- Type A specific:
                require("/BlueWorkforce/scripts/genericConveyorTypeA/common")
                require("/BlueWorkforce/scripts/genericConveyorTypeA/child_main")
            end
        end
