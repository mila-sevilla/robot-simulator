    ...
    function sysCall_init()
        ...
        if isCustomizationScript then
            ...
            if model.modelVersion==1 then
                require("/BlueWorkforce/scripts/ioHub/common")
                require("/BlueWorkforce/scripts/ioHub/customization_main")
                require("/BlueWorkforce/scripts/ioHub/customization_data")
                require("/BlueWorkforce/scripts/ioHub/customization_ext")
                require("/BlueWorkforce/scripts/ioHub/customization_dlg")
            end
        end
