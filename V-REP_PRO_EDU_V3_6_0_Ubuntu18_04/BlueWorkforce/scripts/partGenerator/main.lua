        ...
        if simBWF.getApplication()~='br' then
            ...
            if isCustomizationScript then
                ...
                if model.modelVersion==1 then
                    require("/BlueWorkforce/scripts/partGenerator/common")
                    require("/BlueWorkforce/scripts/partGenerator/customization_main")
                    require("/BlueWorkforce/scripts/partGenerator/customization_dlg")
                end
            else
                -- Child script
