...
function model.readInfo()
    ...
    if not data['bitCoded'] then
        data['bitCoded']=1 -- 1=hidden during sim, 2=calibration balls hidden during sim, 4=free, 8=create parts (online mode), 16=show associated pallet, 32=pick also without target in sight
    end
