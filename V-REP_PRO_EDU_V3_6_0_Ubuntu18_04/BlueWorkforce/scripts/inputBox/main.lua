    ...
    function sysCall_init()
        ...
        if isCustomizationScript then
            ...
            if model.modelVersion==1 then
                require("/BlueWorkforce/scripts/inputBox/common")
                require("/BlueWorkforce/scripts/inputBox/customization_main")
                require("/BlueWorkforce/scripts/inputBox/customization_data")
                require("/BlueWorkforce/scripts/inputBox/customization_ext")
                require("/BlueWorkforce/scripts/inputBox/customization_dlg")
            end
        end
