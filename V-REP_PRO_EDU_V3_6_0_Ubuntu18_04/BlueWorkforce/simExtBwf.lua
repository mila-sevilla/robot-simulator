...
-- Old, V0 stuff:
----------------------------------------------------------
function simBWF.createOpenBox(size,baseThickness,wallThickness,density,inertiaCorrectionFact,static,respondable,color) require("/BlueWorkforce/modelScripts/simExtBwf-v0") return simBWF.createOpenBox(size,baseThickness,wallThickness,density,inertiaCorrectionFact,static,respondable,color) end
function simBWF.generatePalletPoints(objectData) require("/BlueWorkforce/modelScripts/simExtBwf-v0") return simBWF.generatePalletPoints(objectData) end
function simBWF.getCircularPalletPoints(radius,count,angleOffset,center,layers,layerStep,optionalGlobalOffset) require("/BlueWorkforce/modelScripts/simExtBwf-v0") return simBWF.getCircularPalletPoints(radius,count,angleOffset,center,layers,layerStep,optionalGlobalOffset) end
function simBWF.readPartInfoV0(handle) require("/BlueWorkforce/modelScripts/simExtBwf-v0") return simBWF.readPartInfoV0(handle) end
function simBWF.palletPointsToString(palletPoints) require("/BlueWorkforce/modelScripts/simExtBwf-v0") return simBWF.palletPointsToString(palletPoints) end
function simBWF.stringToPalletPoints(txt) require("/BlueWorkforce/modelScripts/simExtBwf-v0") return simBWF.stringToPalletPoints(txt) end
function simBWF.arePalletPointsSame_posOrientAndLayer(pall1,pall2) require("/BlueWorkforce/modelScripts/simExtBwf-v0") return simBWF.arePalletPointsSame_posOrientAndLayer(pall1,pall2) end
function simBWF.readPalletFromFile(file) require("/BlueWorkforce/modelScripts/simExtBwf-v0") return simBWF.readPalletFromFile(file) end
function simBWF.getAllPossiblePartDestinationsV0() require("/BlueWorkforce/modelScripts/simExtBwf-v0") return simBWF.getAllPossiblePartDestinationsV0() end
function simBWF.checkIfCodeAndModelMatch(modelHandle,codeVersion,modelVersion) require("/BlueWorkforce/modelScripts/simExtBwf-v0") return simBWF.checkIfCodeAndModelMatch(modelHandle,codeVersion,modelVersion) end
function simBWF.getAllPossibleTriggerableFeeders(except) require("/BlueWorkforce/modelScripts/simExtBwf-v0") return simBWF.getAllPossibleTriggerableFeeders(except) end
----------------------------------------------------------
